...
public class BlogServiceImpl implements BlogService {
    ...
    public BlogServiceImpl(BlogRepository blogRepository, ReplyRepository replyRepository, UserRepository userRepository, BlogLikeRepository blogLikeRepository) {
...
//            throw new IllegalArgumentException("자신이 작성한 게시글에는 좋아요를 할 수 없습니다.");
    ...
    @Override
    public BlogLike findBlogLike(Blog blog, User user) {
